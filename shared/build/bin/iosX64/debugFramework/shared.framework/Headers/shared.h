...
@class SharedResultError, SharedResultSuccess, SharedArModel, SharedAddressCompanion, SharedAddress, SharedArModelCompanion, SharedCategory, SharedImage, SharedPhone, SharedCafeCompanion, SharedCafe, SharedCategoryCompanion, SharedImageCompanion, SharedPhoneCompanion, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing;

@protocol SharedPlatform, SharedResult, SharedSharedApi, SharedKotlinx_serialization_coreKSerializer, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinIterator, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKotlinKClass, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier;
...
@interface SharedResultError : SharedBase <SharedResult>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)error __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedResultError *shared __attribute__((swift_name("shared")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ResultSuccess")))
@interface SharedResultSuccess : SharedBase <SharedResult>
- (instancetype)initWithData:(id)data __attribute__((swift_name("init(data:)"))) __attribute__((objc_designated_initializer));
- (SharedResultSuccess *)doCopyData:(id)data __attribute__((swift_name("doCopy(data:)")));
...
__attribute__((swift_name("SharedApi")))
@protocol SharedSharedApi
@required
...
*/
- (void)loadAllCafesWithCompletionHandler:(void (^)(id<SharedResult> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("loadAllCafes(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)loadArModelsWithCompletionHandler:(void (^)(NSArray<SharedArModel *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("loadArModels(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)loadCafeByIdId:(int32_t)id completionHandler:(void (^)(id<SharedResult> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("loadCafeById(id:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SharedApiImpl")))
@interface SharedSharedApiImpl : SharedBase <SharedSharedApi>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
- (instancetype)initWithId:(int32_t)id addressName:(NSString *)addressName location:(NSString *)location image:(NSString * _Nullable)image __attribute__((swift_name("init(id:addressName:location:image:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedAddressCompanion *companion __attribute__((swift_name("companion")));
- (SharedAddress *)doCopyId:(int32_t)id addressName:(NSString *)addressName location:(NSString *)location image:(NSString * _Nullable)image __attribute__((swift_name("doCopy(id:addressName:location:image:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *addressName __attribute__((swift_name("addressName")));
...
@interface SharedArModel : SharedBase
- (instancetype)initWithId:(int32_t)id name:(NSString *)name model:(NSString *)model image:(NSString *)image __attribute__((swift_name("init(id:name:model:image:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedArModelCompanion *companion __attribute__((swift_name("companion")));
- (SharedArModel *)doCopyId:(int32_t)id name:(NSString *)name model:(NSString *)model image:(NSString *)image __attribute__((swift_name("doCopy(id:name:model:image:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ArModel.Companion")))
@interface SharedArModelCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedArModelCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Cafe")))
@interface SharedCafe : SharedBase
- (instancetype)initWithId:(int32_t)id title:(NSString *)title description:(NSString *)description avgPrice:(int32_t)avgPrice site:(NSString *)site category:(SharedCategory *)category address:(NSArray<SharedAddress *> *)address images:(NSArray<SharedImage *> *)images phones:(NSArray<SharedPhone *> *)phones schedule:(NSArray<NSString *> *)schedule __attribute__((swift_name("init(id:title:description:avgPrice:site:category:address:images:phones:schedule:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCafeCompanion *companion __attribute__((swift_name("companion")));
- (SharedCafe *)doCopyId:(int32_t)id title:(NSString *)title description:(NSString *)description avgPrice:(int32_t)avgPrice site:(NSString *)site category:(SharedCategory *)category address:(NSArray<SharedAddress *> *)address images:(NSArray<SharedImage *> *)images phones:(NSArray<SharedPhone *> *)phones schedule:(NSArray<NSString *> *)schedule __attribute__((swift_name("doCopy(id:title:description:avgPrice:site:category:address:images:phones:schedule:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedAddress *> *address __attribute__((swift_name("address")));
@property (readonly) int32_t avgPrice __attribute__((swift_name("avgPrice")));
@property (readonly) SharedCategory *category __attribute__((swift_name("category")));
@property (readonly) NSString *description_ __attribute__((swift_name("description_")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
@property (readonly) NSArray<SharedImage *> *images __attribute__((swift_name("images")));
@property (readonly) NSArray<SharedPhone *> *phones __attribute__((swift_name("phones")));
@property (readonly) NSArray<NSString *> *schedule __attribute__((swift_name("schedule")));
@property (readonly) NSString *site __attribute__((swift_name("site")));
@property (readonly) NSString *title __attribute__((swift_name("title")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Cafe.Companion")))
@interface SharedCafeCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCafeCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
- (SharedCategory *)doCopyId:(int32_t)id name:(NSString *)name __attribute__((swift_name("doCopy(id:name:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
...
@interface SharedImage : SharedBase
- (instancetype)initWithId:(int32_t)id image:(NSString *)image name:(NSString *)name __attribute__((swift_name("init(id:image:name:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedImageCompanion *companion __attribute__((swift_name("companion")));
- (SharedImage *)doCopyId:(int32_t)id image:(NSString *)image name:(NSString *)name __attribute__((swift_name("doCopy(id:image:name:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
...
@interface SharedImageCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedImageCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface SharedPhone : SharedBase
- (instancetype)initWithId:(int32_t)id phone:(NSString *)phone description:(NSString *)description __attribute__((swift_name("init(id:phone:description:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPhoneCompanion *companion __attribute__((swift_name("companion")));
- (SharedPhone *)doCopyId:(int32_t)id phone:(NSString *)phone description:(NSString *)description __attribute__((swift_name("doCopy(id:phone:description:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *description_ __attribute__((swift_name("description_")));
...
@interface SharedPhoneCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPhoneCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SharedApiKt")))
@interface SharedSharedApiKt : SharedBase
