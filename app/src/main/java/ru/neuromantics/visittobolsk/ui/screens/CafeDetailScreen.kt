...
import ru.neuromantics.visittobolsk.ui.components.Schedule
...
fun CafeDetailScreen(
    vm: CafeDetailScreenViewModel = koinViewModel(),
    ...
    Scaffold(
        ...
        AnimatedContent(uiState.value, label = "") { state ->
            when (state) {
                is CafeDetailScreenUiState.Content -> {
                ...
                CafeDetailScreenUiState.Error -> {}
                CafeDetailScreenUiState.Loading -> {}
            }
        }
    }
}